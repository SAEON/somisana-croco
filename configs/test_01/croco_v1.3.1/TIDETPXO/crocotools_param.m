...
%
%  Above is commented as we use our own scatter data (received from Chris -
%  2024-03-30)
%
...
add_atm      = 1;       % 1: add atmospheric pressure
%
% Overlap parameters 
%
...
ERA5_dir    = [DATADIR,'ERA5/gulf_for_croco/'];        % where the reformatted GLORYS data are saved
