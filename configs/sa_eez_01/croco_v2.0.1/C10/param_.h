...
# elif defined  SA_EEZ_01
      parameter (LLm0=815,  MMm0=109,  N=40)   ! SA EEZ run
# elif defined  SA_EEZ_02
      parameter (LLm0=815,  MMm0=81,  N=40)   ! SA EEZ run, reduced offshore extent
# else
...
!
      ...
      parameter (NP_XI=MPI_NUM_X,  NP_ETA=MPI_NUM_Y,  NNODES=NP_XI*NP_ETA)
      parameter (NPP=1)
