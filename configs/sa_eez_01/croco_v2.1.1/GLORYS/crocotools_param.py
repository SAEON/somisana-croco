...
# (not used by this configuration - C12 defines CLIMATOLOGY and undefines FRC_BRY,
#  so we generate clm files rather than bry files. Kept for reference; the open
#  boundaries below match the OBC_* keys in C12/cppdefs.h)
