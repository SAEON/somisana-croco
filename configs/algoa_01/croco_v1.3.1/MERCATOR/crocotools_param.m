...
%
CROCO_title  = 'Algoa Bay';
CROCO_config = 'algoa_01';
%
...
grdfile_d3d='delft3d_grid/d3d_01.grd';
%
...
%
CROCOTOOLS_dir = '/croco_tools-v1.3.1/'; % it's baked into the docker image here - see Dockerfile.matlab
%
%  Run directory
%
RUN_dir=[pwd,'/../'];
...
%
FORC_DATA_DIR = [RUN_dir,'DATA/']; % NOT USED IN OUR DIRECTORY STRUCTURE!
%
%if (isoctave == 0)
...
%
%--------------------------------------------------
%  Options for make_GFS 
%--------------------------------------------------
%
My_GFS_dir = [DATADIR,'GFS/']; % GFS native data downloaded
GFS_dir    = [DATADIR,'GFS/for_croco/']; % where the reformatted GFS data are saved
%
% itolap_gfs = 2;       % 2 records = 2 hours (Not Used)
%
%
%--------------------------------------------
