...
%
CROCO_title  = 'Arabian Gulf';
CROCO_config = 'Gulf_02';
%
% need to define lon and lat extents from indices of parent grid.
% Get these indices using nestgui, and export AGRIF_FixedGrids.in
% nested_grid_scatter.m uses the parent grid and indices to define the
% extents of the child grid (bypassing the use of nestgui.m, which we can't
% use to generate the grid from scatter data)
grdname_p='../GRID/croco_grd.nc';
imin=212;
imax=258;
jmin=15;
jmax=57;
...
grdfile_d3d='delft3d_grid/10.grd';
%
...
%
hmin = 3; % we'd like to resolve as shallow as possible!
%
...
%  for this grid.
%
topofile = [DATADIR,'/gulf_bathy_from_chris_2024-03-30/Gulf_data_thinned_every_10th.XYZ'];
%
...
level         = 1;   % AGRIF level; 0 = parent grid
%					  
