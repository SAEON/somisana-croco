...
!$AGRIF_END_DO_NOT_TREAT
     ...
     &                   ,' mynode =', mynode
      ...
      ierr=nf_put_vara_int (ncidrst, rstTstep, start, count, ibuff)
      if (ierr .ne. nf_noerr) then
        if (mynode.eq.0) write(stdout,1) 'time_step_surf', record, ierr
     &                   ,' mynode =', mynode
      endif
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_fwrite(zeta(-1,-1,knew), ncidrst,
     &                                      rstZ, record, r2dvar)
      if (ierr .ne. nf_noerr) then
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_fwrite(ubar(-1,-1,knew), ncidrst,
     &                                     rstUb, record, u2dvar)
      if (ierr .ne. nf_noerr) then
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_fwrite(vbar(-1,-1,knew), ncidrst,
     &                                     rstVb, record, v2dvar)
      if (ierr .ne. nf_noerr) then
     ...
     &                    ierr ,' mynode =', mynode
      ...
      enddo
        ierr=nf_fwrite(trb(-1,-1,0,nstp,itke), ncidrst,
     ...
     &                    ierr ,' mynode =', mynode
        ...
        ierr=nf_fwrite(trb(-1,-1,0,nstp,igls), ncidrst,
     ...
     &                    ierr ,' mynode =', mynode
        ...
        ierr=nf_fwrite(Akv(-1,-1,0), ncidrst,
     ...
     &                    ierr ,' mynode =', mynode
        ...
        ierr=nf_fwrite(Akt(-1,-1,0,itemp), ncidrst,
     ...
     &                    ierr ,' mynode =', mynode
        ...
        ierr=nf_fwrite(Akt(-1,-1,0,isalt), ncidrst,
