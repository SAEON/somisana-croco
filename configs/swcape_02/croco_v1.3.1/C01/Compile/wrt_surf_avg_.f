...
!$AGRIF_END_DO_NOT_TREAT
     ...
     &                 1, MPI_COMM_WORLD, status, ierr)
      ...
      if (iic.eq.0) nrecsurf_avg=nrecsurf_avg+1
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_put_var1_double (ncidsurf_avg, surfTime_avg,
     &                       record, timesurf_avg
     &  )
      if (ierr .ne. nf_noerr) then
     ...
     &                  ,' mynode =', mynode
      ...
      ierr=nf_put_var1_double (ncidsurf_avg, surfTime2_avg,
     &                       record, time
     &  )
      if (ierr .ne. nf_noerr) then
