     ...
     &                          'Spherical grid detected.'
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (lonu(-1,-1), ncid, varid, 0, u2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (latu(-1,-1), ncid, varid, 0, u2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (lonv(-1,-1), ncid, varid, 0, v2dvar)
        if (ierr .ne. nf_noerr) then
      ...
      if (ierr .eq. nf_noerr) then
        ierr=nf_fread (latv(-1,-1), ncid, varid, 0, v2dvar)
        if (ierr .ne. nf_noerr) then
