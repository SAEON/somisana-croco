...
ATTRS = {
    ...
    'temp_clim':      VarAttrs('Day-of-year climatological mean sea water temperature', 'degC', 'sea_water_temperature'),
    'temp_thresh_90': VarAttrs('Day-of-year 90th percentile sea water temperature (marine heatwave threshold)', 'degC', 'sea_water_temperature'),
    'temp_thresh_10': VarAttrs('Day-of-year 10th percentile sea water temperature (marine cold spell threshold)', 'degC', 'sea_water_temperature'),
