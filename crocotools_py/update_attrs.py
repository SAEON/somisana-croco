#
# Here we define our classes of varibales 
# that is used in the somisana github to 
# make our files CF-Compliant.
#
...
class ModelRotatedVectors:
    def __init__(self):
        ...
        self.sustr  = VariableMetadata('Eastward component of surface stress', 'N m2', 'surface_eastward_stress')
        self.bustr  = VariableMetadata('Eastward component of bottom stress', 'N m2', 'bottom_eastward_stress')
        ...
        self.svstr  = VariableMetadata('Northward component of surface stress', 'N m2', 'surface_northward_stress')
        self.bvstr  = VariableMetadata('Northward component of bottom stress', 'N m2', 'bottom_northward_stress')
        self.vbar   = VariableMetadata('Northward component of barotropic velocity', 'm s-1', 'barotropic_northward_sea_water_velocity')

class ModelOriginalVectors:
    def __init__(self):
        self.lon_rho= VariableMetadata('Longitude', 'degrees_east', 'longitude')
        self.lat_rho= VariableMetadata('Latitude', 'degrees_north', 'latitude')       
        self.zeta   = VariableMetadata('Sea Surface Elevation', 'm', 'sea_surface_elevation')
        ...
        self.sustr  = VariableMetadata('Wind stress on sea surface in x direction', 'N m2', 'surface_downward_x_stress')
        self.bustr  = VariableMetadata('Stress due to sea water on sea floor in x direction', 'N m2', 'stress_due_to_sea_water_on_sea_floor_in_x_direction')
