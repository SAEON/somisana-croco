...
if Download_data==1
  ...
  download_ECMWF_3_hourly(Ymin,Ymax,Mmin,Mmax,lonmin,lonmax,latmin,latmax,...
   ...
   for Y=Ymin:Ymax
    ...
    if Y==Ymax
     ...
     for M=mo_min:mo_max
      ...
      disp(['Overlap is ',num2str(itolap_ecmwf),' it of 6 hours'])
      disp(['Overlap is ',num2str(itolap_ecmwf/4),' days before and after'])     
      time=0*(1:tlen);
