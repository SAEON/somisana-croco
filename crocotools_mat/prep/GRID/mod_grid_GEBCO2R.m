...
%
%  original ucla_tools script modified by GGF to be run with crocotools_param.m
%  this version uses the GEBCO bathymetry
%  as the parent and blends it with the bathy contained in the parent croco
%  grid
%
%  This is useful for nesting a CROCO domain into a global model as the
%  global models typically use gebco bathy
%--------------------------------------------------------------
%
...
pargrd=global_topofile; % parent grid in this case is by definition gebco
...
hp=-1*nc{'elevation'}(j,i); % making it positve depth downwards
close(nc)
maskp = hp>0;
