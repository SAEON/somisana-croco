...
%  process data downloaded from https://rda.ucar.edu/datasets/ds094.0/
% 
%  Further Information:  
...
if Download_data==1
  ...
  download_CFSRV2_hourly(Ymin,Ymax,Mmin,Mmax,lonmin,lonmax,latmin,latmax,...
